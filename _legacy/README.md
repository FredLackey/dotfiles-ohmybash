...
> **CURRENT STATUS - REPOSITORY IN TRANSITION**
>
> This repository is currently undergoing significant restructuring and modernization efforts:
>
> - **Origin**: This repo was originally forked from another developer's dotfiles and contains many opinionated configurations that may not align with current needs.
> - **Ongoing Cleanup**: Actively removing unnecessary components and reducing configuration drift.
> - **Major Change - Oh My Bash Integration**: Currently migrating to [Oh My Bash](https://ohmybash.nntoan.com/) to replace custom Bash configurations (autocomplete, prompt customizations, etc.) with native Oh My Bash functionality.
> - **Structure Improvements**: Continuously improving file organization and reducing complexity.
>
> **Note**: The documentation below reflects the original setup process. Some sections may be outdated or subject to change as the migration progresses.
