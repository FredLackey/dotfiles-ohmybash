...
# Raspberry Pi OS Software Installation Script
# Installs core packages for Raspberry Pi OS (Debian-based)
...
main() {
    ...
    . "${script_dir}/../../utils/pios/utils.sh"
    ...
    print_in_green "\n   Raspberry Pi OS installations complete\n\n"
